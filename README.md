...
# React Native Camera Tools [![Backers on Open Collective](https://opencollective.com/react-native-camera-tools/backers/badge.svg)](#backers) [![npm version](https://badge.fury.io/js/react-native-camera-tools.svg)](http://badge.fury.io/js/react-native-camera-tools) [![npm downloads](https://img.shields.io/npm/dm/react-native-camera-tools.svg)](https://www.npmjs.com/package/react-native-camera-tools)
